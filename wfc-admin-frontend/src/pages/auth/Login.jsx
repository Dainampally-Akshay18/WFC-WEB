...
import { Eye, EyeOff, Shield, Lock, Mail, Sparkles, Check } from 'lucide-react';
...
const Login = () => {
  ...
  const features = [
    { icon: Lock, title: 'Military-Grade Security', description: '256-bit encryption & multi-factor authentication' },
    { icon: Sparkles, title: 'Enterprise Ready', description: 'Built for scale with 24/7 support' },
    { icon: Check, title: '99.9% Uptime', description: 'Guaranteed reliability for mission-critical operations' },
  ];
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 transition-all text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                      errors.email ? 'border-red-300 focus:ring-red-500' : 'border-gray-200 dark:border-gray-600 focus:ring-blue-500'
                    }`}
                  />
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 transition-all pr-12 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                        errors.password ? 'border-red-300 focus:ring-red-500' : 'border-gray-200 dark:border-gray-600 focus:ring-blue-500'
                      }`}
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all disabled:opacity-50 shadow-lg"
                >
                  {isLoading ? (
